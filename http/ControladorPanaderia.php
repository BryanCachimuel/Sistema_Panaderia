<?php
    class ControladorPanaderia {
        ...
        public function listarPanaderia() {
            ...
            $v = count($lista);
            $respuesta = new Encapsulamiento($v ? EMensajes::CORRECTO : EMensajes::ERROR);
        ...
        public function actualizarPanaderia($panaderia) {
            ...
            $v = ($actualizados > 0);
            $respuesta = new Encapsulamiento($v ? EMensajes::ACTUALIZACION_EXITOSA : EMensajes::ERROR);
        ...
        public function eliminarPanaderia($idPanaderia) {
            ...
            $v = ($eliminados > 0);
            $respuesta = new Encapsulamiento($v ? EMensajes::ELIMINACION_EXITOSA : EMensajes::ERROR);
        ...
        public function buscarPanaderiaPorId($idPanaderia) {
            ...
            $v = ($panaderia != null);
            $respuesta = new Encapsulamiento($v ? EMensajes::BUSQUEDA_ID_EXITOSA : EMensajes::ERROR);
